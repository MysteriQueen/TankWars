...
public class HardGameView extends SurfaceView implements SurfaceHolder.Callback, SensorEventListener {
    ...
    private volatile HardGameThread thread;
    ...
    public HardGameView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setThread(HardGameThread newThread) {
    ...
    public HardGameThread getThread() {
        return thread;
    }
        ...
        if(thread!=null) {
            ...
            if(thread.getState() == Thread.State.NEW){
                ...
                if(thread.getState() == Thread.State.TERMINATED){
                    ...
                    //thread = new HardLvlGame(this, null);
                    thread = new HardLvlGame(this);
                    thread.setRunning(true);
                    thread.start();
                }
            }
