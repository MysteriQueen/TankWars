...
class clHardETank {
    ...
    clHardETank(Bitmap oTankBmp, float fTankX, float fTankY, float fTankSpeedX, boolean bBulletFired, Bitmap oTankBulletBmp, float fBulletX, float fBulletY, float fBulletSpeed, float fBulletSpeedX, float fBulletSpeedY) {
 ...
 * @author Riya Mayor
 */
public class HardLvlGame extends HardGameThread {
     ...
     */
    public HardLvlGame(HardGameView gameView) {
        //House keeping
        super(gameView);
        ...
        oTankBmp = BitmapFactory.decodeResource(gameView.getContext().getResources(), R.drawable.smallredtank_down);      //ARR
    ...
    public void setupBeginning() {
        ...
        mRockY[0] = mCanvasHeight / 2;

        mRockX[1] = mCanvasWidth * 2 / 3;
        mRockY[1] = mCanvasHeight * 7 / 12;

        mRockX[2] = mCanvasWidth / 2;
        mRockY[2] = mCanvasHeight * 3 / 10;
        ...
        //ARR start ...
        //Initialise enemy array list
        //THIS ADDS 3 ENEMY TANKS TO THE ARRAY LIST if there are less than 3 already there
        //1st enemy tank
        if (arETank.size() < 3) {
            ...
            arETank.add(new clHardETank(oTankBmp, fTankX, fTankY, fTankSpeedX, bBulletFired, oTankBulletBmp, fBulletX, fBulletY, fBulletSpeed, fBulletSpeedX, fBulletSpeedY));
            //3rd enemy tank
            fTankX = mCanvasWidth / 2;
            fTankY = oTankBmp.getHeight() + 15;
            fBulletX = fTankX + oTankBmp.getWidth() / 2;
            fBulletY = fTankY + oTankBmp.getHeight() + 5;
            fTankSpeedX = 8;
            arETank.add(new clHardETank(oTankBmp, fTankX, fTankY, fTankSpeedX, bBulletFired, oTankBulletBmp, fBulletX, fBulletY, fBulletSpeed, fBulletSpeedX, fBulletSpeedY));
        }
    }
    ...
    protected void updateGame(float secondsElapsed) {
        ...
        for(int i = 0; i < arETank.size(); i++) {
            ...
            float startX = 0;
            //if first 2 tanks are reaching the edge of their halves, or 3rd tank is reaching edge of canvas ...
            switch (i) {
                case 0 :
                case 1 : startX = mCanvasWidth - mCanvasWidth / (i+1);
                    ...
                    break;
                case 2 :  if ((oElement.fTankX <= oElement.oTankBmp.getWidth() / 4 && oElement.fTankSpeedX < 0) ||
                              (oElement.fTankX >= mCanvasWidth - oElement.oTankBmp.getWidth() / 2 && oElement.fTankSpeedX > 0))
                        oElement.fTankSpeedX = -oElement.fTankSpeedX;
                    break;
            }
            ...
            //if enemy tank has not fired a bullet, then fire one to supply continuous barrage
            if (!oElement.bBulletFired) {
                makeETankBullet(i);
            }
            else {
